...
class UR5PickEnviornment:
    ...
    def move_joints(self, target_joint_state, acceleration=10, speed=0.5):
        """
    ...
    def move_tool(self, position, orientation, acceleration=10, speed=0.5):
        """
    ...
    def robot_go_home(self, speed=0.5):
    ...
    def execute_place(self):
        self.move_joints([
            0, -np.pi/2, np.pi/2, -np.pi/2, -np.pi/2, 0], speed=0.5)
        self.open_gripper()
        self.robot_go_home(speed=0.5)
